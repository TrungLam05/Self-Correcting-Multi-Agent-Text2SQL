...
def explain_generated_sql(
    ...
    """Generate explanation for already-generated SQL (separate LLM call)."""
...
"""
    ...
    tables = [t.name for t in schema.tables if t.name.lower() in sql_query.lower()]
